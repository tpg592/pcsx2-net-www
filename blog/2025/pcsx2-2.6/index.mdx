...
Here is some eye candy for those looking for visuals. It will be almost impossible to post all the fixes games since there are a lot, so here's just a few:
